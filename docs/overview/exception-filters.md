<!-- 此文件从 content/overview/exception-filters.md 自动生成，请勿直接修改此文件 -->
<!-- 生成时间: 2026-02-28T11:23:59.619Z -->
<!-- 源文件: content/overview/exception-filters.md -->
...
第二种方法是使用[这里所示](/overview/exception-filters#绑定过滤器) 的 `APP_FILTER` 令牌。
